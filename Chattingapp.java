...
public class Chattingapp implements ActionListener {
    ...
    Chattingapp() {
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("prbhas.png"));
        Image i5 = i4.getImage().getScaledInstance(50, 50, Image.SCALE_DEFAULT);
        JLabel profile = new JLabel(new ImageIcon(i5));
        profile.setBounds(40, 10, 50, 50);
        p.add(profile);

        JLabel name = new JLabel("Prabhas Raju");
